export type ClientStatus = 'active' | 'inactive' | 'completed' | 'on_hold';
...
export const FOOD_FREQUENCY_FIELDS = [
  'fruits', 'vegetables', 'dairy_products', 'fast_food', 'sweets',
  'sugary_drinks', 'tea_coffee', 'fried_foods', 'bakery_products', 'packaged_foods',
] as const;
